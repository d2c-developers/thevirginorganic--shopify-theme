...
import CartRelatedProductUpsell from './CartRelatedProductUpsell';
  ...
  return (
    <Transition show={isOpen}>
      <div className="fixed top-0 right-0 w-full h-screen z-50">
        ...
        <TransitionChild>
          <button
            className="absolute inset-0 z-10 bg-black opacity-75 data-[closed]:opacity-0 duration-200 transition-opacity"
        ...
        <TransitionChild>
          <div className="absolute z-20 top-0 right-0 h-screen w-full max-w-[375px] bg-white flex flex-col duration-200 transition-transform data-[closed]:translate-x-full translate-x-0">
            ...
            <CartRelatedProductUpsell productId={cart?.items[0]?.product_id} />
